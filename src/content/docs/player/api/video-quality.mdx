...
and why you should consider adaptive streaming protocols such as HLS. However, you can also load
different resolutions using multiple video files, see [Source Sizes][source-sizes].
