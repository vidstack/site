...
:::info
Video quality tracking and selection is currently only supported by the [HLS Provider][hls-provider].
:::
...
and why you should consider adaptive streaming protocols such as HLS.
