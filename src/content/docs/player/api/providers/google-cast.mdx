...
If there are no devices available, a [toast is shown][toast-preview] at the top of the screen to prevent opening
an empty prompt. You can prevent showing the toast and display your own message like so:
