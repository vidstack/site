...
[install]: /docs/player/getting-started/installation/react?styling=default-layout&provider=video

## Demo

You can try out the Default Layout on our [player demo](/player/demo?layout=default&framework=react) page.
