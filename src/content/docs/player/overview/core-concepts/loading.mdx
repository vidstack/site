...
- `vod`: Video on Demand (VOD) Content that is pre-recorded and can be accessed and played at any
...
<img src={hlsManifestImage.src} alt="" decoding="async" loading="lazy" />
