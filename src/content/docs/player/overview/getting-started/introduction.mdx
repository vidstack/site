...
See our [player demo](/player/demo) to play with our default layouts. You can also find a
comprehensive set of [player examples][vidstack-examples] on GitHub. Find the specific
example you're interested in and click the "Open in StackBlitz" button in the respective README. This
will launch the project on [StackBlitz][stackblitz] in a remote development
